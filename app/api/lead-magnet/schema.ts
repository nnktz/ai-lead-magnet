...
export const leadMagnetCreateRequest = z.object({
  ...
  draftBody: z.string({
    required_error: 'Draft body is required',
  }),
  draftSubtitle: z.string({
    required_error: 'Draft subtitle is required',
  }),
  draftTitle: z.string({
    required_error: 'Draft title is required',
  }),
  draftPrompt: z.string({
    required_error: 'Draft prompt is required',
  }),
  ...
  publishedBody: z.string({
    required_error: 'Published body is required',
  }),
  publishedSubtitle: z.string({
    required_error: 'Published subtitle is required',
  }),
  publishedTitle: z.string({
    required_error: 'Published title is required',
  }),
  publishedPrompt: z.string({
    required_error: 'Published prompt is required',
  }),
